    ...
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <a-col :xl="2" :lg="4" :md="6" :sm="24">
          ...
          <a-col :xl="3" :lg="6" :md="8" :sm="24">
            <a-form-item label="客户AB类型">
              <j-dict-select-tag placeholder="请选择客户AB类型" v-model="queryParam.customTypeAb" dictCode="ps_custom_ab"/>
            </a-form-item>
          </a-col>
          <a-col :xl="3" :lg="6" :md="8" :sm="24">
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item @click="qiehuan(record.id)">
                  <a>AB盘切换</a>
              </a-menu-item>
              <a-menu-item>
  ...
  export default {
    ...
    methods: {
      ...
      qiehuan(id){
        ...
        this.$confirm({
          ...
          onOk: function () {
            ...
            getAction('/bg/custom/customAb?customId='+id, {}).then((res) => {
              if(res.result == true){
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'customTypeAb',text:'客户AB类型',dictCode:'ps_custom_ab'})

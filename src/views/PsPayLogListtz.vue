<template>
 ...
 <a-form-model-item label="返利状态" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="accountStatus">
            ...
            <a-form-model-item v-if="details.accountStatus == 2" label="拒绝理由" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="remark">
              <a-input v-model="details.remark" placeholder="请输入拒绝理由" ></a-input>

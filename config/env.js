export default {
  basePath: "https://api.amizaon.com/jeecg-boot",
  action: 'https://api.amizaon.com/jeecg-boot/sys/common/upload',
  imgaction : 'https://api.amizaon.com/jeecg-boot/sys/common/static',
  strings: '/sys/common/static/',
  oldurl:'https://api.amizaon.com/jeecg-boot/sys/common/static/'

export default {
  basePath: "https://api.natuercan.com/jeecg-boot",
  action: 'https://api.natuercan.com/jeecg-boot/sys/common/upload',
  imgaction : 'https://api.natuercan.com/jeecg-boot/sys/common/static',
  strings: '/sys/common/static/',
  oldurl:'https://api.natuercan.com/jeecg-boot/sys/common/static/'

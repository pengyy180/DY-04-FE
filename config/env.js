export default {
  basePath: "https://api.aililbaba.com/jeecg-boot",
  action: 'https://api.aililbaba.com/jeecg-boot/sys/common/upload',
  imgaction : 'https://api.aililbaba.com/jeecg-boot/sys/common/static',
  strings: '/sys/common/static/',
  oldurl:'https://api.aililbaba.com/jeecg-boot/sys/common/static/'

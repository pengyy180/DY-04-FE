<template>
  <view class="page">
    ...
    <view class="logo">
      <image src="../../static/styleimg/iherbl.png" mode=""></image>
	</view>
	<!-- <view class="logo2">
    ...
    <view class="operation">
      <text></text>
      <text @click="onLogin" style="color:rgb(201, 147, 76);text-align: center;">已有手机号?登录</text>
    </view>
  </view>
</template>
...
export default {
  ...
  methods: {
	  checkchina (e) {
	  		  // form.phone=form.phone..replace(/[\u4e00-\u9fa5/\s+/]|[`~!@#$%^&*() \\+ =<>?"{}|, \\/ ;' \\ [ \] ·~！@#￥%……&*（）—— \\+ ={}|《》？：“”【】、；‘’，。、_.-:]/g, "")
	        console.log(e)
	        this.form.phone = e.detail.value.replace(/[^\w\/]/ig,'')
	      },
    onLogin() {
      uni.redirectTo({

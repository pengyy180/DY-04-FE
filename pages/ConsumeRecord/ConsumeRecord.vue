<template>
	<view class="page">
		...
		<view class="record-list">
			<view class="list" v-for="(item,index) in moneylist" :key="index" @click="urldetails(item.id)" v-if="item.accountType != 5">
				...
				<view class="title-date">
					...
					<view class="errortext" v-if="item.accountStatus == 2"> 
						{{item.remark}}
					</view>
					<view class="date">

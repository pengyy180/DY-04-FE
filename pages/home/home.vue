  ...
  <view class="page">
	...
	<!-- </view> -->
      <view class="main" >
		...
		<view class="ya-typelist">
			<view class="list">
				<view class="li">
					<image src="../../static/t1.png"></image>
					<view>點我享折扣</view>
				</view>
				<view class="li">
					<image src="../../static/t2.png"></image>
					<view>百貨慶會場</view>
				</view>
				<view class="li">
					<image src="../../static/t3.png"></image>
					<view>隨身保健</view>
				</view>
				<view class="li">
					<image src="../../static/t4.png"></image>
					<view>常溫食糧</view>
				</view>
			</view>
			<view class="list">
				<view class="li">
					<image src="../../static/t5.png"></image>
					<view>99免運費</view>
				</view>
				<view class="li">
					<image src="../../static/t6.png"></image>
					<view>萊爾富免運</view>
				</view>
				<view class="li">
					<image src="../../static/t7.png"></image>
					<view>全場6折</view>
				</view>
				<view class="li">
					<image src="../../static/t8.png"></image>
					<view>滿立減</view>
				</view>
			</view>
		</view>
				...
				<view class="list" v-for="(item, index) in goodsList"
				  ...
				  :key="index" >
					<view class="li">
						...
						<view class="selling-price"> <text>$</text> {{item.productPrice}}</view>
						<view class="line-p">
							商品熱賣中
						</view>
		...
		<view class="bgfff">
			...
			<view class="new-product">
			  <view class="goods-list"  >
				<view class="list" v-for="(item, index) in goodsList2.slice(0,5)"
				  @click="godetails(item.id)"
				  :key="index" >
					<view class="li">
						<view class="top">
		...
		<view class="protypelist">
			<view class="list"  >
				<view class="li" v-for="(item, index) in classList2" @click="gotype(item, index)">
					<image :src="item.coverImg" mode="aspectFit"></image>
					<view class="">
						{{item.name}}
					</view>

      ...
      <view class="price-info" >
        ...
        <view class="info">
         <!-- <view class="list" @click="onDepreciate">
		  ...
		  <view class="jsj">
			 <text class="del">进口税+¥288</text> 限时活动减税
		  </view>
      ...
      <view class="list" @click="gourl">
        ...
        <view class="content">
          <view class="serve">
            ...
            <text >{{userinfo.addressProvi == null ? '请填写收货地址':userinfo.addressProvi}}</text>
          </view>
        </view>
        <view class="more">
          <text class="iconfont icon-more"></text>

<template>
  ...
  <view @click="isMore = false">
    ...
    <view class="banner-title">
	  ...
	  <!-- <view class="tablist">
	  	<view class="li">
	  		<image src="../../static/img/biaoqian.png"></image> Naturecan优质产品
	  	</view>
	  	<view class="li ">
	  ...
	  <view class="goods-title">
		...
		<view class="price-start">
			<u-rate :value="4.8" active-color="#2f6669" inactive-color="#b2b2b2" :allowHalf="false" ></u-rate>(19 Reviews)
		</view>
	  </view>
...
import __config from "../../config/env.js";
	...
	import homenav from "../../components/homenav.vue";//判断用户信息
